    ...
    constructor() {
        ...
        this.extract = (videoUrl) => __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                let decryptKey = yield (yield axios_1.default.get("https://github.com/enimax-anime/key/blob/e6/key.txt")).data;
                decryptKey = (0, utils_1.substringBefore)((0, utils_1.substringAfter)(decryptKey, '"blob-code blob-code-inner js-file-line">'), "</td>");
                if (!decryptKey) {
                    decryptKey = yield (yield axios_1.default.get("https://raw.githubusercontent.com/enimax-anime/key/e6/key.txt")).data;
                }
                if (!decryptKey)
